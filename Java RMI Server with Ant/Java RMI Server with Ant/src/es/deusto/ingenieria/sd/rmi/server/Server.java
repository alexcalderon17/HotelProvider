...
public class Server extends UnicastRemoteObject implements IServer {
	...
	@Override
	public String obtenerApartamentos() throws RemoteException, InvalidUser{
		String answer=null;
		String url = "https://ds2324.arambarri.eus/api/apartamentos";
		String token = "";
		...
		try{
			...
			if(response.statusCode()==200){
				...
				System.out.println(" da error, el código es:" + response.statusCode());
